...
const uint8_t defaultKeyAES[16] = { 0x01, 0x23 , 0x45 , 0x67 ,
            0x89 , 0xab , 0xcd , 0xef ,
            0x12 , 0x34 , 0x56 , 0x78 ,
            0x9a , 0xbc , 0xde , 0xf0 };
...
int main(){
  ...
  for (i = 0; i < RXBUFFERLENGTH; i++) rxBuffer[i] = 0;

/////////////// doing cipher with LED flashing, self generating pt ///////////////

  // while(1) {

  //   AES128_ECB_encrypt(rxBuffer, keyAES, cipher_output); 

  //   for (i = 0; i < 16; i++)
  //     print_hex(rxBuffer[i], 2);
  //   putchar('\n');

  //   for (i = 0; i < 16; i++)
  //     rxBuffer[i] = cipher_output[i];
    
  // }

/////////////// doing cipher with LED flashing, CW generating pt ///////////////
...
/////////////// CW capture ///////////////
  ...
  while(1) {
    ...
    for (i = 0; i < 16; i++){print_hex(rxBuffer[i], 2);}
    putchar('G');
    ...
    ///// send ct /////
    while( getchar() != 'Q');
    for (i = 0; i < 16; i++){print_hex(cipher_output[i], 2);}
